...
export default function Home() {
  return (
    <main className={styles.Home}>
      ...
      <section>
        <img alt="200th birth design" src="../../../dist/assets/200th-birth.png" />

        <div className={styles.hands}>
          <img alt="globe with hands" src="../../../dist/assets/globe-hands.jpeg" />
        ...
        <div className={styles.world}>
          <img alt="world center" src="../../../dist/assets/world-center.jpeg" />
        ...
        <div className={styles.national}>
          ...
          <img alt="chicago house of worship" src="../../../dist/assets/chicago-national-center.jpeg" />
        </div>
      </section>
    </main>
  );
