...
export default function Home() {
  return (
    <>
      <p>Welcome to the website of the Wilsonville Baha'i Community.  We are a community devoted to the cause of the oneness of humanity and to promoting love and concord among all His children.  Our belief is firmly rooted in the concept of unity in diversity.</p>
